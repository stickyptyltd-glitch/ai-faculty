...
| **Sales Engineering & Technical Pre-Sales** | sales engineers, solutions consultants, technical pre-sales, founders doing technical demos | technical discovery that scopes the real requirement · grounded demos (only what's actually built) · RFP/RFI responses that don't overclaim compliance · verified technical claims in proposals · honest objection-handling under deal pressure |
| **Education Leadership & Ed-Tech Governance** | principals, superintendents, school/district administrators, academic-technology leads | evaluate vendor AI claims before adopting · draft AI-use policy grounded in named risk · communicate decisions honestly to parents/staff · staff training matched to real skill levels · AI-flagged incidents decided by a human |
| **Real Estate** | real estate agents, brokers, property managers, listing coordinators | verify listing claims, screened for fair-housing language · build CMAs from real, representative comps · stay honest about property condition · get contract/offer paperwork a real human review · defer jurisdiction-specific legal questions to a real check |
| **Journalism & Media** | journalists, editors, fact-checkers, newsletter writers, media startup founders | what AI can and can't do in the newsroom · grounded claims (every fact traces to a source) · sourcing, attribution & provenance · corrections, disclosure & integrity under pressure · the produce → verify → decide workflow |
...
| **Built & available (24), each with a capstone:** _Using AI at work_ — Software (S1–S5), Content (M1–M4), Operations & Admin (O1–O5), Customer Support (SU1–SU5), Research & Analysis (R1–R5), Education & Training (ED1–ED5), Legal & Contracts (L1–L5), Sales (SL1–SL5), Finance & Accounting (FN1–FN5), HR & People (HR1–HR5), Healthcare & Clinical Support (HC1–HC5), Product Management (PM1–PM5), Public Sector & Government Services (PS1–PS5), Design & UX (UX1–UX5), Consulting & Advisory Services (CONS1–CONS5), Sales Engineering & Technical Pre-Sales (SE1–SE5), Education Leadership & Ed-Tech Governance (EDL1–EDL5), Real Estate (RE1–RE5), Journalism & Media (J1–J5). _Building AI_ — AI Engineering (E1–E5), Technical Foundations (F1–F5), Machine Learning Practitioner (ML1–ML5), Agentic Systems (AG1–AG5), AI Safety / Evals / Red-teaming (SF1–SF5). 126 competencies total (v0.40). | — |
| **Next: more domains** — professional services variants and industry-specific academies. | Author them |
